                        ...
                        <>
                            {voucherCodes.map((code: VoucherCode) => (
                                <TableRow key={code.id}>
                                    ...
                                    <TableCell>
                                        {code.issued_to || <span className="text-gray-400">N/A</span>}
                                    </TableCell>
                                    <TableCell>
                                        {code.expires_at || <span className="text-gray-400">N/A</span>}
                                    </TableCell>
                                    ...
                                    <TableCell className="text-nowrap text-right">
                                        <button className="rounded-full hover:bg-gray-200 transition">
    ...
    return (
        <Popover>
            ...
            <PopoverContent className="w-max cursor-pointer p-0 text-sm">
                ...
                <Form method="POST" action={`vouchers/${voucherCode.id}/delete`} className="">
